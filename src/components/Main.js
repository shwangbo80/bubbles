...
export default function Main() {
  return (
    <Container className="bg-white text-center main-container">
      <div className="bg-blueberry hero-container hero-image">
        <Image
          fluid
          className="img-container hero-icon mt-5"
          src="./media/boba.png"
        />
      ...
      <Container className="px-0">
        <Row className="text-center img-container">
          <Col md={4} className="px-0">
            ...
            <h4 className="mt-2 mb-5 text-blueberry">What is Boba?</h4>
          </Col>
          <Col md={4} className="px-0">
            <a href="/how">
              <Image
            ...
            <h4 className="mt-2 mb-5 text-blueberry">Bubble Tea Preparation</h4>
          </Col>
          <Col md={4} className="px-0">
            <a href="/list">
              <Image
            ...
            <h4 className="mt-2 mb-5 text-blueberry">See our list of Bobas</h4>
          </Col>
        </Row>
        <Row>
          <Col></Col>
          <Col md={8} className="about-container p-5">
            ...
            <p className="px-5 pt-4">
              Bubbles is a portfolio project by Soo Hwangbo for Nucamp Coding
              Bootcamp. It is built on ReactJS with bootstrap framework.
            </p>
          </Col>
          <Col></Col>
        </Row>
